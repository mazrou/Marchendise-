...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form method="POST">
      <input type="text"  class="fadeIn second" name="nom" placeholder="nom" required>
      <input type="text"  class="fadeIn third" name="prenom" placeholder="presnom" required>
      ...
      <input type="submit" class="fadeIn fourth" value=" Regester" name ="regester">
    </form>
