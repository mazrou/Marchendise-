...
?>
        <div class="card">
            ...
            <div class="container">
                <h2><?= $re[1].' '. $re[2]?></h2>
                <p class="title"><?= $re[3]?></p>
                <p><?= 'tel: 0'.$re[5].'   '.'fax: 0'. $re[6]?></p>
                <p><?= $re[7]?></p>
            ...
            <tr>
                ...
                if($ctrl=='profilclient'){
                    ...
                    <td>
                        ...
                        <a style="color: #21bfbf" href="/web/public/admin/profilclient/<?=$dem[8]?>" onclick="">profil client</a>
...
<div style="display: inline-flex;width: 100%" >
    <button   style="width:10%;margin-left: 15px;margin-right: 15px ;"><a style="color: #f7f5fe" href= <?php if($ctrl=='profilclient'){echo "/web/public/admin/client";} else {if($ctrl=='document'){echo '/web/public/admin/document';}else {echo "/web/public/admin/traducteur";}} ?>  >retour</a></button>
</div>