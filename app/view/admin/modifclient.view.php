...
<div id="id01" class="modal">
    ...
    <form class="modal-content animate" action="" method="post">
        ...
        <div class="container">
            ...
            <input type="text" placeholder="Enter Tel" name="tel" required value=<?php echo $this->_params[3]; ?>>



            <button type="submit" name="submit50" value="save">modifier</button>
...
<div style="display: inline-flex;width: 100%" >
    <button   style="width:10%;margin-left: 15px;margin-right: 15px ;"><a style="color: #f7f5fe" href= "/web/public/admin/client"> retour</a></button>
</div>