  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	              <a href="add"><span class="fa fa-user mr-3 "></span> Ajouter un transportateur</a>
	          </li>
	          <li >
	          ...
	          <li class="active">
              <a href="#"><span class="fa fa-suitcase mr-3"></span> Transportateurs</a>
	          </li>
	          <li>
       ...
       <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody id="items">
                       ...
                       <?php
                  foreach ($this->_data["transportateurs"] as $march) {
                   echo '<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle ">
                      <td>' . $march->getNom() . '</td>
                      <td>' . $march->getAddresse() . '</td>
                      <td>' . $march->getTelephone() . '</td>
                      <td>' . $march->getEmail() . '</td>
