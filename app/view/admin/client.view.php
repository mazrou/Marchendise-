...
<form class="modal-content animate" action="" method="post">
    <button type="submit" name="submit100"  style="width:10%;margin-left: 15px;margin-right: 15px ;">trier selon</button>
    <select name="tree" style="width:15%; height:auto;">
        <option value="nom">nom</option>
        <option value="nbddemande">nb demande</option>
    </select>

    <button type="submit" name="submit101"  style="width:10%;margin-left: 15px;margin-right: 15px ;">filtrer selon</button>
    <select name="tree1" style="width:15%; height:auto;">
        <option value="clinbl">cilent non bloques</option>
        <option value="clibl">cilent bloques</option>
        <option value="clidem">cilent a effectuer des demandes</option>
        <option value="clindem">cilent n a pas effectuer des demandes</option>
        <option value="touscli">tous les cilents</option>
    </select>
</form>
<br/><br/><br/>
<div>
    ...
    <?php
        ...
        foreach ($client as $cli) {
            ...
            <tr>
                ...
                <td>
                    <a style="color: #21bfbf" href="/web/public/admin/blockerclient/<?=$cli[0]?>/<?=$cli[5]?>"><i class="fa fa-edit"></i>blocker</a>
                    <a style="color: #21bfbf" href="/web/public/admin/modifclient/<?=$cli[0]?>/<?= $cli[1]?>/<?= $cli[2]?>/<?=$cli[3]?>" onclick="">modif</a>
                    <a style="color: #21bfbf" href="/web/public/admin/deleteclient/<?=$cli[0]?>" onclick="">delete</a>
                    <a style="color: #21bfbf" href="/web/public/admin/profilclient/<?=$cli[0]?>" onclick="">profil</a>
                </td>
