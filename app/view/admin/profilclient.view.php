   ...
   if(isset($url[1]) && $url[1] != '') {
    ...
    foreach ($demandeclie as $dem) {
        ...
        <tr>
            ...
            <td><?= $dem[6]?></td>
            <?php
            if($ctrl=='profiltraducteur'){

            }
            else {?>
                <td>

                <a style="color: #21bfbf" href="/web/public/admin/profiltraducteur/<?=$dem[8]?>" onclick="">profil traducteur</a>
...
<div style="display: inline-flex;width: 100%" >
    <button   style="width:10%;margin-left: 15px;margin-right: 15px ;"><a style="color: #f7f5fe" href=<?php if($ctrl=='profiltraducteur'){echo "/web/public/admin/traducteur";} else {echo "/web/public/admin/client";} ?>>retour</a></button>
</div>