...
<h1>list traducteur</h1>
<form class="modal-content animate" action="" method="post">
    <button type="submit" name="submit105"  style="width:10%;margin-left: 15px;margin-right: 15px ;">trier selon</button>
    <select name="tree3" style="width:15%; height:auto;">
        <option value="nom">nom</option>
        <option value="nbdoc">nb documents traduise</option>
    </select>

    <button type="submit" name="submit106"  style="width:10%;margin-left: 15px;margin-right: 15px ;">filtrer selon</button>
    <select name="tree4" style="width:15%; height:auto;">
        <option value="tradnbl">traducteur non bloques</option>
        <option value="tradbl">traducteur bloques</option>
        <option value="traddem">traducteur a effectuer des demandes</option>
        <option value="tradndem">traducteur n a pas effectuer des demandes</option>
        <option value="tous">tous les traducteurs</option>
    </select>
</form>
<br/><br/><br/>
<table class="data">
    ...
    if(false!==$traducteur){
        foreach ($traducteur as $trad) {
            ...
            <tr>
                ...
                <td>
                    <a style="color: #21bfbf" href="/web/public/admin/blockertraducteur/<?=$trad[0]?>/<?=$trad[10]?>"><i class="fa fa-edit"></i>blocker</a>
                    <a style="color: #21bfbf" href="/web/public/admin/modiftraducteur/<?=$trad[0]?>/<?=$trad[1]?>/<?=$trad[2]?>/<?=$trad[3]?>/<?=$trad[5]?>/<?=$trad[6]?>" onclick="">modif</a>
                    <a style="color: #21bfbf" href="/web/public/admin/deletetraducteur/<?=$trad[0]?>" onclick="">delete</a>
                    <a style="color: #21bfbf" href="/web/public/admin/profiltraducteur/<?=$trad[0]?>" onclick="">profil</a>
...
<div style="display: inline-flex;width: 100%" >
    <button   style="width:10%;margin-left: 15px;margin-right: 15px ;"><a href="/web/public/admin/main"style="color: #f7f5fe">retour</a></button>
</div>